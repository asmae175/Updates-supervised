...
from bindsnet.network.plot import Plot
from bindsnet.utils import load_data, make_dirs, msg_wrapper, sample_from_class
...
class Spiking:
    ...
    def save_result(self) -> None:
        ...
        file_path = os.path.join(self.results_path, "trained_network_v2_2layer.pt")
        file_path1 = os.path.join(self.results_path, "trained_network_v2_dict_2layers.pt")
        self.network.save(file_path)
        torch.save(self.network.state_dict(), file_path1)
        ...
        if self.gif:
            ...
            file_path = os.path.join(self.results_path, "weight_maps1.gif")
    ...
    def save_acc(self) -> None:
        ...
        if any(len(v) > 1 for v in self.acc_history.values()):
            file_path = os.path.join(self.results_path, "acc_graph1.png")
